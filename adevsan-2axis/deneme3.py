...
button_ABS_A = machine.Pin(27, machine.Pin.IN, machine.Pin.PULL_UP)
button_ABS_C = machine.Pin(28, machine.Pin.IN, machine.Pin.PULL_UP)
...
# display.draw_rectangle(0, 0, 320, 240, color565(255, 255, 255))
    ...
    display.draw_text(100, 20, 'ENC - A', unispace, color565(255, 128, 0))
    display.draw_text(220, 20, 'ENC - C', unispace, color565(255, 128, 0))
...
def show_Enc_A_Angle():
    ...
    if ((last_abs_a_degree != abs_degree_a) or (last_inc_a_degree != inc_degree_a)):
        ...
        string_abs_A = "{:.1f}".format(last_abs_a_degree)
        string_inc_A = "{:.1f}".format(last_inc_a_degree)
